...
export default function RecruiterSettingsPage() {
  ...
  const handleDeactivate = async () => {
    if (!confirm("Are you sure you want to deactivate your recruiter account? This action can only be reversed by contacting administration.")) {
      return;
    }
    ...
    <div className="flex flex-col gap-8 w-full max-w-xl">
      ...
      <div className="p-6 md:p-8 bg-white dark:bg-zinc-900 border border-zinc-150 dark:border-zinc-800 rounded-3xl shadow-sm flex flex-col gap-6">
        <div>
          ...
          <p className="text-xs text-zinc-450 mt-1">Portal follows your system light or dark preferences automatically.</p>
        </div>
        ...
        <div className="border-t border-zinc-100 dark:border-zinc-850 pt-6">
          ...
          <p className="text-xs text-zinc-400 mt-1">Deactivate your employer account. All your active job postings will be hidden from public browse listings.</p>
